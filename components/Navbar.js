                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      ...
                      >
                        ...
                        aria-current={item.current ? 'page' : undefined}>{item.name}</button>
                      </Link>
                    ))}
                  </div>
                </div>
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <Link
                            href="/business/user"
                          >
                            <button className={classNames(active ? 'bg-emerald-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>Seu perfil</button>
                          </Link>
                        )}
                      </Menu.Item>
                      <Menu.Item>
